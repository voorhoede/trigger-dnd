...
const status = {
  ...
  set remainingTime(value) {
    ...
    BrowserWindow.getAllWindows().forEach(this.sendCurrentStatus.bind(this))
    this._listeners.remainingTime.forEach((fn) =>
      fn(this._remainingTime, prevValue),
    )
  },
  ...
  set slackEnabled(value) {
    ...
    BrowserWindow.getAllWindows().forEach(this.sendCurrentStatus.bind(this))
    this._listeners.slackEnabled.forEach((fn) =>
      fn(this._slackEnabled, prevValue),
    )
  },
  ...
  set slackBusyIcon(value) {
    ...
    BrowserWindow.getAllWindows().forEach(this.sendCurrentStatus.bind(this))
    this._listeners.slackBusyIcon.forEach((fn) =>
      fn(this._slackBusyIcon, prevValue),
    )
  },
  ...
  set googleCalendarEnabled(value) {
    ...
    BrowserWindow.getAllWindows().forEach(this.sendCurrentStatus.bind(this))
    this._listeners.googleCalendarEnabled.forEach((fn) =>
      fn(this._googleCalendarEnabled, prevValue),
    )
  },
  ...
  set googleCalendarIsFetching(value) {
    ...
    BrowserWindow.getAllWindows().forEach(this.sendCurrentStatus.bind(this))
    this._listeners.googleCalendarIsFetching.forEach((fn) =>
      fn(this._googleCalendarIsFetching, prevValue),
    )
  },
  ...
  set googleToken(value) {
    ...
    BrowserWindow.getAllWindows().forEach(this.sendCurrentStatus.bind(this))
    this._listeners.googleToken.forEach((fn) =>
      fn(this._googleToken, prevValue),
    )
  },
  ...
  set googleCalendarDndOnly(value) {
    ...
    BrowserWindow.getAllWindows().forEach(this.sendCurrentStatus.bind(this))
    this._listeners.googleCalendarDndOnly.forEach((fn) =>
      fn(this._googleCalendarDndOnly, prevValue),
    )
  },
  ...
  set googleCalendarUntilNext(value) {
    ...
    BrowserWindow.getAllWindows().forEach(this.sendCurrentStatus.bind(this))
    this._listeners.googleCalendarUntilNext.forEach((fn) =>
      fn(this._googleCalendarUntilNext, prevValue),
    )
  },
...
status.googleCalendarEvents = new Proxy([], {
  set(target, prop, value) {
    ...
    status._listeners.googleCalendarEvents.forEach((fn) =>
      fn(status.googleCalendarEvents),
    )
    return true
  },
})
