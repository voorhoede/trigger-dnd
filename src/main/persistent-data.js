...
status.on('googleClientId', updateSetting('googleClientId'))
status.on('googleClientSecret', updateSetting('googleClientSecret'))
status.on('googleProjectId', updateSetting('googleProjectId'))